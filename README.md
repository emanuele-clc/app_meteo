...
Prende la posizione dal GPS (oppure cerco la città a mano) e mostra il meteo attuale, l'andamento ora per ora e i sette giorni successivi. Toccando un giorno ne vedo le ore. Le città che mi interessano posso salvarle e richiamarle con un tocco. In alto c'è il consiglio della giornata, ricavato dai dati meteo; volendo posso collegare una chiave Groq per farlo scrivere da un modello AI in modo più discorsivo, ma senza chiave funziona comunque con delle regole.

C'è anche un box per fare domande dirette ("porto l'ombrello alle 18?", "meglio uscire ora o nel pomeriggio?"): con la chiave AI risponde a domande libere, senza chiave gestisce le domande su un orario preciso.
